                                ...
                                <tbody className={`divide-y divide-gray-100 dark:divide-gray-700 ${isDarkMode ? '' : 'bg-white'}`}>
                                  {adminUsers.map((u, i) => (
                                    <tr key={u.id} className={`${isDarkMode ? 'hover:bg-gray-700/50' : 'hover:bg-gray-50 bg-white'} transition-colors`}>
                                      ...
                                      <td className={`p-3 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>{u.mobileNumber}</td>
                                      <td className={`p-3 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>{u.email}</td>
                                    </tr>
                                  ))}
                                </tbody>
                              </table>
  ...
  return (
    <div className="flex gap-2">
      <div className="relative w-20">
        <select
          className={`w-full p-3 rounded-xl text-sm outline-none focus:ring-1 focus:ring-blue-500 appearance-none transition-colors ${isDarkMode ? 'bg-gray-700 text-white' : 'bg-gray-50 text-gray-900'}`}
          value={countryCode}
      ...
      <input
        ...
        required
        className={`flex-1 p-3 rounded-xl text-sm outline-none focus:ring-1 focus:ring-blue-500 transition-colors ${isDarkMode ? 'bg-gray-700 text-white placeholder-gray-500' : 'bg-gray-50 text-gray-900'}`}
        value={value}
